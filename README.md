...
- **Programming Languages & Frameworks**: Python, JAX, C++, C , Verilog, VHDL, Pytorch, Tensorflow, PyGAD, Huggingface, LLM-API's, Matplotlib, OpenCV, Pillow, Git/Github, Notebooks.
